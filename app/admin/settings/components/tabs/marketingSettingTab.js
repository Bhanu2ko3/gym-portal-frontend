...
const settingsList = [
  { name: "Automations Sending Active", key: "automationsActive", default: false },
  { name: "Enable Referral Rewards", key: "referralRewards", default: false },
  { name: "Enable Reward Amount", key: "rewardAmount", default: false },
];
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 w-full mx-auto">
      ...
      <div className="mt-10 flex justify-center">
        <Button text="Save Settings" onClick={() => console.log("Marketing settings saved!")} />
      </div>
    </div>
  );
};

...
const settingsList = [
  { name: "Email Sending Active", key: "emailSendingActive", default: false },
  {
    name: "Direct replies to member / lead profile",
    key: "directRepliesToProfile",
    default: false,
  },
  {
    name: "Receive replies to automated emails to the member profile",
    key: "receiveRepliesToAutomatedEmails",
    default: false,
  },
  {
    name: "Receive replies to automated emails to the member profile",
    key: "receiveRepliesToMemberProfile",
    default: false,
  },
];
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 w-full mx-auto">
      ...
      <div className="mt-10 flex justify-center">
        <Button
          text="Save Settings"
          onClick={() => console.log("Email settings saved!")}
        />
      </div>
    </div>
  );

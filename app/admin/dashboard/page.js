    ...
    <div className="flex flex-col lg:flex-row bg-[var(--tertiary-color)] h-screen ">
        ...
        <main className="flex-1 bg-[var(--tertiary-color)]">
          <div className="py-6 sm:px-3 lg:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              {stats.map((stat) => (
                ...
                >
                  ...
                  <div className="text-sm text-[var(--primary-color)] capitalize">
                    {stat.label}
                  </div>
                </div>
              ))}
            ...
            <div className="bg-white rounded-lg shadow-md p-4 h-124 ">
              <h2 className="text-lg text-gray-700 font-medium ml-3">
                Schedule Today
              </h2>
              <div className="min-h-80">
                {scheduleItems.length > 0 ? (
                  <div>{/* Schedule items would go here */}</div>
                ) : (
      ...
      <div className="w-full lg:w-64 lg:h-150 min-h-80 bg-white mt-6 lg:mr-4 mb-6 shadow-md rounded-lg">
        <div className="p-4 border-b border-gray-200">
          <h1 className="ml-1 text-gray-700 font-medium text-lg">
            Notifications
          </h1>
        </div>
        <div className="">
          {notifications.length > 0 ? (
            <div className="p-4">{/* Notification items would go here */}</div>
          ) : (
